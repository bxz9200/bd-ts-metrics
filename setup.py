...
setuptools.setup(
    ...
    url='https://github.com/betterdataai/ts-metrics/tree/pip',
    license='MIT',
    install_requires=['numpy==1.18.5', 'matplotlib==3.5.3', 'scipy==1.7.3', 'dtaidistance==2.3.12', 'tensorflow==1.15.5', 'scikit-learn==1.0.2',
